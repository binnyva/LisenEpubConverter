...
function bookDetailFromRoot(root: string, workRoot: string, stateOverride?: WorkState): object {
  ...
  return { epubPath, epubAvailable: fs.existsSync(epubPath), root: rootResolved, state, metadata, analysis, characterRegistry, characterObservations, casting, bindings, chapters };
}
